...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DorisComponentVPASpec) DeepCopyInto(out *DorisComponentVPASpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DorisComponentVPASpec.
func (in *DorisComponentVPASpec) DeepCopy() *DorisComponentVPASpec {
	if in == nil {
		return nil
	}
	out := new(DorisComponentVPASpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DorisComponentVPASyncStatus) DeepCopyInto(out *DorisComponentVPASyncStatus) {
	*out = *in
	if in.VpaRef != nil {
		in, out := &in.VpaRef, &out.VpaRef
		*out = new(AutoScalerRef)
		**out = **in
	}
	if in.VpaStatus != nil {
		in, out := &in.VpaStatus, &out.VpaStatus
		*out = new(autoscaling_k8s_iov1.VerticalPodAutoscalerStatus)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DorisComponentVPASyncStatus.
func (in *DorisComponentVPASyncStatus) DeepCopy() *DorisComponentVPASyncStatus {
	if in == nil {
		return nil
	}
	out := new(DorisComponentVPASyncStatus)
	in.DeepCopyInto(out)
	return out
}
